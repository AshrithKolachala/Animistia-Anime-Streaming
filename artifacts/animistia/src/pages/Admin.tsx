...
export default function Admin() {
  ...
  const [episode, setEpisode] = useState({ episodeNumber: 1, title: '', synopsis: '', sourceType: 'uploaded' as ShowSourceType, videoUrl: null as string | null, videoPath: null as string | null });
...
function SeriesManager({ seasons, selectedSeasonId, setSelectedSeasonId, seasonNumber, setSeasonNumber, seasonTitle, setSeasonTitle, saveSeason, episodes, episode, setEpisode, saveEpisode, deleteEpisode, uploading, uploadEpisode, busy }: { seasons: import('@workspace/api-client-react').Season[]; selectedSeasonId: number | null; setSelectedSeasonId: (id: number) => void; seasonNumber: number; setSeasonNumber: (value: number) => void; seasonTitle: string; setSeasonTitle: (value: string) => void; saveSeason: (event: React.FormEvent) => void; episodes: Episode[]; episode: { episodeNumber: number; title: string; synopsis: string; sourceType: ShowSourceType; videoUrl: string | null; videoPath: string | null }; setEpisode: (episode: { episodeNumber: number; title: string; synopsis: string; sourceType: ShowSourceType; videoUrl: string | null; videoPath: string | null }) => void; saveEpisode: (event: React.FormEvent) => void; deleteEpisode: (id: number) => void; uploading: boolean; uploadEpisode: (event: React.ChangeEvent<HTMLInputElement>) => void; busy: boolean }) {
  return (
